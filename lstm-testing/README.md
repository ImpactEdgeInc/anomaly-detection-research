...
This folder contains executable notebooks that test Long Short-Term Memory (LSTM) neural network models on some of our sustainability data. 
...
The individual notebooks can be executed step by step. Note that the model training procedure may take considerable time and processing, especially in the case of the `emission_reduction_lstm` file.
